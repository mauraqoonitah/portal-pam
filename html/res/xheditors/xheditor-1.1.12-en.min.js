(function(e, Z) {
    ...
    e.fn.xheditor = function(j) {
        ...
        this.each(function() {
            if (e.nodeName(this, "TEXTAREA"))
                ...
                o = new sa(this, j);
                if (o.init()) this.xheditor = o, n.push(o)
            }
        });
        0 === n.length && (n = !1);
        1 === n.length && (n = n[0]);
    ...
    e("script[src*=xheditor]").each(function() {
        var e = this.src;
        if (e.match(/xheditor[^\/]*\.js/i)) return J = e.replace(/[\?#].*$/, "").replace(/(^|[\/\\])[^\/]*$/, "$1"), !1
    });
    if (j) try {
    ...
    var lb = {
        ...
        sa = function(z, n) {
            ...
            function H(a) {
                if (27 === a.which) return ua ? c.removeModal() : R && c.hidePanel(), !1
            }
            ...
            function Ua(a) {
                var b, d, f;
                if (a && (b = a.originalEvent.clipboardData) && (d = b.items) && (f = d[0]) && "file" == f.kind && f.type.match(/^image\//i)) return a = f.getAsFile(), b = new FileReader, b.onload = function() {
                ...
                setTimeout(function() {
                    ...
                    if (b = b.replace(/^[\s\uFEFF]+|[\s\uFEFF]+$/g, ""))
                        if (a) c.pasteText(b);
                        else if (b = c.cleanHTML(b), b = c.cleanWord(b), b = c.formatXHTML(b), !g.onPaste || g.onPaste && !1 !== (b = g.onPaste(b))) b =
                        Va(b), c.pasteHTML(b);
                    Ia = !1
                }, 0)
            }
            ...
            function Va(a) {
                ...
                if (b && d) {
                    var f = [],
                        h = 0,
                        a = a.replace(/(<img)((?:\s+[^>]*?)?(?:\s+src="\s*([^"]+)\s*")(?: [^>]*)?)(\/?>)/ig, function(a, d, c, e, r) {
                            /^(https?|data:image)/i.test(e) && !b.test(e) && (f[h] = e, c = c.replace(/\s+(width|height)="[^"]*"/ig, "").replace(/\s+src="[^"]*"/ig, ' src="' + va + 'img/waiting.gif" remoteimg="' + h++ + '"'));
                            return d + c + r
                        });
                    0 < f.length && e.post(d, {
                        urls: f.join("|")
            ...
            function Ca(a) {
                ...
                else return c.pasteHTML("<br />"), j && 0 < a.length && 2 === c.getRng().parentElement().childNodes.length && c.pasteHTML("<br />"), !1
            }

            function Ma() {
                !ra && !Q && (ka && A.height("100%").css("height", A.outerHeight() - q.outerHeight()), j && q.hide().show())
            }
            ...
            function K(a, b, d) {
                if (!b) return !1;
                var c = "_xhe_" + b;
                d && (wa && (d = U(d, wa, E)), a.attr(b, E ? U(d, "abs",
            ...
            function pb(a) {
                ...
                var a = la[sKey],
                    f;
                for (f in a)
                    if (f = a[f], e.isFunction(f)) {
                        if (!1 === f.call(c)) return !1
                    } else return c.exec(f), !1
            }

            function L(a, b) {
                var d = typeof a;
                return !b ? "undefined" != d : "array" === b && a.hasOwnProperty && a instanceof Array ? !0 : d ===
                    b
            }
            ...
            function U(a, b, d) {
                ...
                if ("rel" !== b && (a.match(/^(https?:\/\/|\/)/i) || (a = c + a), "/" === a.charAt(0))) {
                    for (var m = [], a = a.split("/"), k = a.length, c = 0; c < k; c++) i = a[c], ".." === i ? m.pop() : "" !== i && "." !== i && m.push(i);
                    "" === a[k - 1] && m.push("");
                    a = "/" + m.join("/")
                }
            ...
            var c = this,
                y = e(z),
                Ya = y.closest("form"),
                q, A, V, ea, l, fa, ma = y.offsetParent().css("zIndex"),
                ga, La = !1,
                x = !1,
                ka = !1,
                Ia = !1,
                ...
                W = null,
                N = 0,
                g = c.settings = e.extend({}, sa.settings, n),
                ya = g.plugins,
                za = [];
            ya && (ja = e.extend({}, ja, ya), e.each(ya, function(a) {
                za.push(a)
            }), za = za.join(","));
            ...
            if (g.editorRoot) J = g.editorRoot;
            !1 === eb && (J = U(J, "abs"));
            ...
            var ab = "xheCSS_" + g.skin,
                ...
                Qa = "",
                Ba = e.extend({}, Ba, g.emots),
                X = U(X, "rel", E ? E : null);
            (na = g.showBlocktag) && (P += " showBlocktag");
            var la = [];
            this.init = function() {
                ...
                if (a = g.loadCSS)
                    if (L(a, "array"))
                        for (var i in a) O += '<link rel="stylesheet" href="' + a[i] + '"/>';
                    else O = a.match(/\s*<style(\s+[^>]*?)?>[\s\S]+?<\/style>\s*/i) ? O + a : O + ('<link rel="stylesheet" href="' + a + '"/>');
                i = "<html><head>" + O + "<title>WYSIWYG Editor,press alt+1-9,toogle to tool area,press tab,select button,press esc,return editor " +
                ...
                ea = e(V);
                try {
                    this.doc = l = V.document, fa = e(l), l.open(), l.write(i), l.close(), j ? l.body.contentEditable = "true" : l.designMode = "On"
                } catch (k) {}
                setTimeout(Ka, 300);
                c.setSource();
                V.setInterval = null;
                q.append(d.join("")).bind("mousedown contextmenu", M).click(function(a) {
                    ...
                    b.is(".xheEnabled") && (clearTimeout(xa),
                ...
                q.find(".xheButton").hover(function(a) {
                    ...
                    if (f && 10 < f) return oa = !0, setTimeout(function() {
                        oa = !1
                    }, 100), !1;
                    var i = b.attr("cmd");
                    if (1 !== ja[i].h) return c.hidePanel(), !1;
                    Pa && (d = 0);
                    ...
                    if (ha) {
                        var b = a.clientX - ha.x,
                            c = a.clientY - ha.y;
                        if (1 < Math.abs(b) || 1 < Math.abs(c)) 0 < b && 0 < c ? (b = Math.round(Math.atan(c / b) / 0.017453293), W = W ? (W + b) / 2 : b) : W = null, ha = {
                            x: a.clientX,
                            y: a.clientY
                        }
                    }
                ...
                Q && ea.click(ob);
                fa.mousedown(Na).keydown(pb).keypress(Ca).dblclick(o).bind("mousedown click", function(a) {
                    y.trigger(a.type)
                });
                if (j) {
                    ...
                    fa.bind("controlselect", function(a) {
                        a = a.target;
                ...
                fa.keydown(function(a) {
                    var b = a.which;
                    if (a.altKey && 49 <= b && 57 >= b) return q.find("a").attr("tabindex", "0"), q.find(".xheGStart").eq(b -
                ...
                q.keydown(function(a) {
                    var b = a.which;
                    if (27 == b) q.find("a").attr("tabindex", "-1"), c.focus();
                    else if (a.altKey && 49 <= b && 57 >= b) return q.find(".xheGStart").eq(b - 49).next().find("a").focus(), !1
                });
                i = e(l.documentElement);
                Ra ? i.bind("keydown", function(a) {
                ...
                g.html5Upload && i.bind("dragenter dragover",
                    ...
                    if (a && (b = a.files) && 0 < b.length) {
                        var d, f, a = ["Link", "Img", "Flash", "Media"],
                            i = [],
                            k;
                        for (d in a) f = a[d], g["up" + f + "Url"] && g["up" + f + "Url"].match(/^[^!].*/i) && i.push(f + ":," + g["up" + f + "Ext"]);
                        if (0 === i.length) return !1;
                        k = i.join(",");
                        f = function(a) {
                            var b, c;
                            for (d = 0; d < a.length; d++)
                                if (b = a[d].name.replace(/.+\./, ""), b = k.match(RegExp("(\\w+):[^:]*," + b + "(?:,|$)",
                                        "i")))
                                    if (c) {
                                        if (c !== b[1]) return 2
                                    } else c = b[1];
                        ...
                        1 === f ? alert("Upload file extension required for this: " + k.replace(/\w+:,/g, "")) : 2 === f ? alert("You can only drag and drop the same type of file.") : f && c.startUpload(b, g["up" + f + "Url"], "*", function(a) {
                            var b = [],
                                d;
                            (d = g.onUpload) && d(a);
                            for (var r = 0, i = a.length; r < i; r++) d = a[r], url = L(d, "string") ? d : d.url, "!" === url.substr(0, 1) && (url = url.substr(1)), b.push(url);
                            c.exec(f);
                ...
                (i =
                    g.shortcuts) && e.each(i, function(a, b) {
                    c.addShortcuts(a, b)
                });
                $++;
                La = !0;
            ...
            this.setTextCursor = function(a) {
                ...
                if (j) b.moveToElementText(d);
                    ...
                    for (var e =
                            a ? "lastChild" : "firstChild"; 3 != d.nodeType && d[e];) d = d[e];
                    b.selectNode(d)
                }
                b.collapse(a ? !1 : !0);
            ...
            this.getRng = function(a) {
                var b, d;
                try {
                    a || (b = c.getSel(), d = b.createRange ? b.createRange() : 0 < b.rangeCount ? b.getRangeAt(0) : null), d || (d = l.body.createTextRange ? l.body.createTextRange() : l.createRange())
                } catch (e) {}
                return d
            };
            this.getParent = function(a) {
                var b = c.getRng(),
                    d;
                j ? d = b.item ? b.item(0) :
                    b.parentElement() : (d = b.commonAncestorContainer, b.collapsed || b.startContainer === b.endContainer && 2 > b.startOffset - b.endOffset && b.startContainer.hasChildNodes() && (d = b.startContainer.childNodes[b.startOffset]));
                a = a ? a : "*";
                d = e(d);
            ...
            this.getSelect = function(a) {
                ...
                d.cloneContents ? (a = e("<div></div>"), (d = d.cloneContents()) && a.append(d),
                    d = a.html()) : d = L(d.item) ? d.item(0).outerHTML : L(d.htmlText) ? d.htmlText : d.toString();
                f && (d = "");
            ...
            this.pasteHTML = function(a, b) {
                ...
                } else "control" === d.type.toLowerCase() && (d.clear(), f = c.getRng()), f.pasteHTML(a);
                var h = e("#_xhe_temp", l),
                    m = h[0];
                ...
                if ("write" === b) {
                    a = a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g,
                        function(a, b, c, d, e, f, h) {
                            ...
                            else if ("a" === d) !e.match(/ href=[^ ]/i) && e.match(/ name=[^ ]/i) && (D += " xhe-anchor"), h && (f = "></a>");
                            else if ("table" === d && !c && (a = e.match(/\s+border\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i), !a || a[1].match(/^(["']?)\s*0\s*\1$/))) D += " xhe-border";
                            var Y, e = e.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g, function(a,
                                b, c) {
                                b = b.toLowerCase();
                                c = c.match(/^(["']?)(.*)\1/)[2];
                                aft = "";
                            ...
                            p && (a = X + (p[0] ? p[0] : "default") + "/" + p[1] + ".gif", e += ' src="' + a + '" _xhe_src="' +
                                a + '"');
                    ...
                    if (!Q) var c = function(a, b, c, d) {
                            var b = "",
                                e, f;
                            (e = c.match(/font-family\s*:\s*([^;"]+)/i)) && (b += ' face="' + e[1] + '"');
                            ...
                            if (f = c.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)) {
                                if (e =
                                    f[1].match(/\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i)) {
                                    f[1] = "#";
                    ...
                    if (Q)
                        for (var e = [{
                                ...
                                return c ? "<" + c + ">" + h + "</" + c + ">" : a
                            }, h = 0; 2 > h; h++) a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/ig,
                    ...
                    a = a.replace(/(<(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/g, function(a, b, c, d, e) {
                        var c = c.toLowerCase(),
                            f, d = d.replace(/\s+_xhe_(?:src|href)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function(a,
                                b) {
                                f = b.match(/^(["']?)(.*)\1/)[2];
                                return ""
                            });
                        ...
                        d = d.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g, function(a, b, c) {
                            ...
                            if ("class" === b) {
                                ...
                                "style" === b && (c = c.replace(/(^|;)\s*(font-size)\s*:\s*([a-z-]+)\s*(;|$)/i, function(a,
                                    b, c, d, e) {
            ...
            this.cleanWord = function(a) {
                ...
                if (0 < b && 3 > b && a.match(/mso(-|normal)|WordDocument|<table\s+[^>]*?x:str/i))
                    for (var a = a.replace(/<\!--[\s\S]*?--\>|<!(--)?\[[\s\S]+?\](--)?>|<style(\s+[^>]*?)?>[\s\S]*?<\/style>/ig,
                            ""), a = a.replace(/\r?\n/ig, ""), a = a.replace(/(<(\/?)([\w\-:]+))((?:\s+[\w\-:]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))?)*)\s*(\/?>)/g, function(a, c, d, i, g, u) {
                            i = i.toLowerCase();
                            if (i.match(/^(link|img)$/) && g.match(/file:\/\//i) || i.match(/:/) || "span" === i && 2 === b) return "";
                            d || (g = g.replace(/\s([\w\-:]+)(?:\s*=\s*("[^"]*"|'[^']*'|[^>\s]+))?/ig, function(a, c, d) {
                                c = c.toLowerCase();
                                d = d.match(/^(["']?)(.*)\1/)[2];
                            ...
                            return c + g + u
                        }), c = 0; 3 > c; c++) a = a.replace(/<([^\s>]+)(\s+[^>]*)?>\s*<\/\1>/g, function(a, b) {
            ...
            this.cleanHTML = function(a) {
                var a = a.replace(/<!?\/?(DOCTYPE|html|body|meta)(\s+[^>]*?)?>/ig, ""),
                    b, a = a.replace(/<head(?:\s+[^>]*?)?>([\s\S]*?)<\/head>/i, function(a, c) {
                ...
                if (!g.linkTag || !g.inlineScript || !g.inlineStyle) a = a.replace(/(<(\w+))((?:\s+[\w-]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/ig, function(a, b, c, e, i) {
            ...
            this.formatXHTML = function(a, b) {
                ...
                function r() {
                    G.push("\r\n");
                    if (0 < w)
                        for (var a = w; a--;) G.push("\t")
                }

                function s(a, b, c, d) {
                    if (!c) return d;
                    a = "";
                    (b = c.match(/ face\s*=\s*"\s*([^"]+)\s*"/i)) && (a += "font-family:" + b[1] + ";");
                    (b = c.match(/ size\s*=\s*"\s*(\d+)\s*"/i)) && (a += "font-size:" + S[(7 < b[1] ? 7 : 1 > b[1] ? 1 : b[1]) - 1].s + ";");
                    (b = c.match(/ color\s*=\s*"\s*([^"]+)\s*"/i)) && (a += "color:" +
                        b[1] + ";");
                    (c = c.match(/ style\s*=\s*"\s*([^"]+)\s*"/i)) && (a += c[1]);
                ...
                for (var v, B, o = 0, t, z, w = -1, y = "body", A = !1; v = q.exec(a);) {
                    B = v.index;
                    B > o && (o =
                        a.substring(o, B), t ? z.push(o) : i(o));
                    o = q.lastIndex;
                    if (B = v[1])
                        if (B = e(B), t && B === t && (k(z.join("")), z = t = null), !t) {
                            g(B);
                            continue
                        }
            ...
            this.toggleSource = function(a) {
                if (x !== a) {
                    ...
                    var b = l.body,
                        ...
                        f, h, a = 0,
                        g = "";
                    if (x) f = c.getSource(), d.html("").removeAttr("scroll").attr("class",
                        "editMode" + P), j ? b.contentEditable = "true" : l.designMode = "On", ra && (c._exec("inserthtml", "-"), e("#" + Aa).show().focus().hide()), g = "Edit source code";
                    else {
            ...
            this.showPreview = function() {
                var a = g.beforeSetSource,
                    b = c.getSource();
                a && (b = a(b));
                var a = "<html><head>" + O + "<title>Preview</title>" + (E ? '<base href="' + E + '"/>' : "") + "</head><body>" + b + "</body></html>",
                    b = window.screen,
            ...
            this.showMenu = function(a, b) {
                ...
                d.click(function(a) {
                    a = a.target;
                    if (!e.nodeName(a, "DIV")) return c.loadBookmark(), b(e(a).closest("a").attr("v")),
                        c.hidePanel(), !1
                }).mousedown(M);
                c.saveBookmark();
                c.showPanel(d)
            ...
            this.showColor = function(a) {
                ...
                b.click(function(b) {
                    ...
                    if (e.nodeName(b, "A")) return c.loadBookmark(),
                        a(e(b).attr("xhev")), c.hidePanel(), !1
                }).mousedown(M);
                c.saveBookmark();
                c.showPanel(b)
            };
            this.showPastetext = function() {
                var a = e('<div><label for="xhePastetextValue">Use Ctrl+V on your keyboard to paste the text.</label></div><div><textarea id="xhePastetextValue" wrap="soft" spellcheck="false" style="width:300px;height:100px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),
            ...
            this.showLink = function() {
                ...
                if (1 === h.length) {
                    if (!h.attr("href")) return w = null, c.exec("Anchor");
                    i.val(K(h, "href"));
                ...
                b.click(function() {
                    ...
                    if ("" !== a && "http://" !== a) {
                        ...
                        if (1 < b.length) {
                            ...
                            "" !==
                            d && (g += ' target="' + d + '"');
                            for (var g = g + ">xhe_tmptext</a>", f = "" !== u ? u : f ? f : a, j = 0, qb = b.length; j < qb; j++) a = b[j], "" !== a && (a = a.split("||"), d = g, d = d.replace("xhe_tmpurl", a[0]), d = d.replace("xhe_tmptext", a[1] ? a[1] : f), Y.push(d));
                            c.pasteHTML(Y.join("&nbsp;"))
                        } else a = b[0].split("||"), f || (f = a[0]), f = a[1] ? a[1] : "" !== u ? "" : f ? f : a[0], 0 === h.length ? (f ? c.pasteHTML('<a href="#xhe_tmpurl">' + f + "</a>") : c._exec("createlink", "#xhe_tmpurl"), h = e('a[href$="#xhe_tmpurl"]', l)) : f && !Q && h.text(f), K(h, "href", a[0]), "" !== d ? h.attr("target",
                            d) : h.removeAttr("target")
                    }
                    c.hidePanel();
                    return !1
                });
            ...
            this.showAnchor = function() {
                var a = e('<div><label for="xheAnchorName">Anchor name: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="Ok" /></div>'),
                    b = c.getParent("a"),
                    d = e("#xheAnchorName", a),
                    f = e("#xheSave", a);
                if (1 === b.length) {
                    if (b.attr("href")) return w = null, c.exec("Link");
                    d.val(b.attr("name"))
                }
                f.click(function() {
                    c.loadBookmark();
                ...
                s.click(function() {
                    ...
                    if ("" !== a && "http://" !== a) {
                        ...
                        if (1 < g.length) {
                            ...
                            var v = v + " />",
                                w;
                            for (w in g) a = g[w], "" !== a && (a = a.split("||"), p = v, p = p.replace("xhe_tmpurl", a[0]), a[1] && (p = '<a href="' +
                                a[1] + '" target="_blank">' + p + "</a>"), t.push(p));
                            c.pasteHTML(t.join("&nbsp;"))
                        } else 1 === g.length && (a = g[0], "" !== a && (a = a.split("||"), 0 === b.length && (c.pasteHTML('<img src="' + a[0] + '#xhe_tmpurl" />'), b = e('img[src$="#xhe_tmpurl"]', l)), K(b, "src", a[0]), "" !== p && b.attr("alt", p), "" !== cls_ && b.attr("class", cls_), "" !== s ? b.attr("align", s) : b.removeAttr("align"), "" !== F ? b.attr("width", F) : b.removeAttr("width"), "" !== j ? b.attr("height", j) : b.removeAttr("height"), "" !== n ? b.attr("border", n) : b.removeAttr("border"), "" !== o ? b.attr("vspace", o) : b.removeAttr("vspace"),
                            "" !== q ? b.attr("hspace", q) : b.removeAttr("hspace"), a[1] && (g = b.parent("a"), 0 === g.length && (b.wrap("<a></a>"), g = b.parent("a")), K(g, "href", a[1]), g.attr("target", "_blank"))))
            ...
            this.showEmbed = function(a, b, d, f, g, m, i) {
                ...
                1 === k.length && (u.val(K(k,
                    "src")), r.val(k.attr("width")), s.val(k.attr("height")));
                a.click(function() {
                    c.loadBookmark();
                    var a = u.val();
                    if ("" !== a && "http://" !== a) {
                        ...
                        if (1 < m.length) {
                            var n, o = [],
                                ...
                                q;
                            for (q in m) a = m[q].split("||"), n = j, n = n.replace("xhe_tmpurl", a[0]), n = n.replace("xhe_width", a[1] ? a[1] : b), n = n.replace("xhe_height", a[2] ? a[2] : i), "" !==
                                a && o.push(n);
                            c.pasteHTML(o.join("&nbsp;"))
            ...
            this.showEmot = function(a) {
                var b = e('<div class="xheEmot"></div>'),
                    ...
                    d = d.list;
                if (r)
                    for (d = 1; d <= r; d++) g++, m.push("<a href=\"javascript:void('" + d + '\')" style="background-image:url(' + f + d + '.gif);" emot="' + a + "," + d + '" xhev="" title="' + d + '" role="option">&nbsp;</a>'), 0 === g % u && m.push("<br />");
                else e.each(d, function(b, c) {
                    g++;
                ...
                i = e("<style>" + (s ? ".xheEmot div{width:" + (r + 20) + "px;height:" + s + "px;}" : "") + ".xheEmot div a{width:" + i + "px;height:" + k + "px;}</style><div>" + m.join("") + "</div>").click(function(a) {
                    var a = a.target,
                        b = e(a);
                    if (e.nodeName(a, "A")) return c.loadBookmark(), c.pasteHTML('<img emot="' + b.attr("emot") + '" alt="' + b.attr("xhev") + '">'), c.hidePanel(), !1
                }).mousedown(M);
                b.append(i);
                var j = 0,
                    p = ['<ul role="tablist">'];
                e.each(Ba, function(b, c) {
                    j++;
                    p.push("<li" + (a === b ? ' class="cur"' : "") + ' role="presentation"><a href="javascript:void(\'' +
            ...
            this.showTable = function() {
                ...
                e("#xheSave", a).click(function() {
                    ...
                    var a = s.val(),
                        ...
                        w = u.val(),
                        z = r.val(),
                        e = "<table" + ("" !== e ? ' border="' + e + '"' : "") + ("" !== o ? ' width="' + o + '"' : "") + ("" !== q ? ' height="' +
            ...
            this.uploadInit = function(a, b, d) {
                function f(b) {
                    ...
                    var c = !1,
                        ...
                        f, h = [];
                    (d = g.onUpload) && d(b);
                    for (d = 0; d < e; d++) f = b[d], f = L(f, "string") ? f : f.url, "!" === f.substr(0, 1) && (c = !0, f = f.substr(1)), h.push(f);
                    a.val(h.join(" "));
                ...
                if ("!" === b.substr(0, 1)) m.click(function() {
                    c.showIframeModal("Upload file", b.substr(1), f, null, null)
                });
                else {
                    ...
                    setTimeout(function() {
                        a.closest(".xheDialog").bind("dragenter dragover", M).bind("drop", function(a) {
                            var a = a.originalEvent.dataTransfer,
                                e;
            ...
            this.startUpload = function(a, b, d, f) {
                function h(a, d) {
                    ...
                    e.err === Z || e.msg === Z ? alert(b + " upload interface error!\r\n\r\nreturn error:\r\n\r\n" + a) : e.err ? alert(e.err) : (m.push(e.msg),
                        g = !0);
                    (!g || d) && c.removeModal();
                    d && g && f(m);
                    return g
                ...
                var m = [],
                    i = g.html5Upload,
                    k = i ? g.upMultiple : 1,
                    j, r = e('<div style="padding:22px 0;text-align:center;line-height:30px;">File uploading,please wait...<br /></div>'),
                ...
                if (!i || a.nodeType && (!(j = a.files) || !j[0].name)) {
                    ...
                    a = j.length;
                    if (a > k) {
                        alert("Please do not upload more then " + k + " files.");
                        return
                    }
                    for (k = 0; k < a; k++)
                        if (!Wa(j[k].name, d)) return;
                    var l =
                        e('<div class="xheProgress"><div><span>0%</span></div></div>');
                    r.append(l);
                    d = new c.html5Upload("filedata", j, b, h, function(a) {
                        if (0 <= a.loaded) {
                ...
                c.showModal("File uploading(Esc cancel)", r, 320, 150);
                d.start()
            };
            ...
            this.html5Upload = function(a, b, c, e, g) {
                ...
                for (var k,
                        l = 0, r = b.length, s = 0, n = 0, p = this, o = 0; o < r; o++) n += b[o].size;
                this.remove = function() {
                    k && (k.abort(), k = null)
                };
                this.uploadNext = function(a) {
                    a && (s += b[l - 1].size, i(0));
                    (!a || a && !0 === e(a, l === r)) && l < r && j(b[l++], c, p.uploadNext, function(a) {
                        i(a)
                    })
                };
                this.start = function() {
            ...
            this.showIframeModal = function(a, b, d, f, g, j) {
                function i() {
                    try {
                        s.callback = k, s.unloadme = c.removeModal, e(s.document).keydown(H), n = s.name
                    } catch (a) {}
                }
                ...
                var b = e('<iframe frameborder="0" src="' +
                        b.replace(/{editorRoot}/ig, J) + (/\?/.test(b) ? "&" : "?") + "parenthost=" + location.host + '" style="width:100%;height:100%;display:none;" /><div class="xheModalIfmWait"></div>'),
                    l = b.eq(0),
                    r = b.eq(1);
            ...
            this.showModal = function(a, b, d, f, h) {
                ...
                f =
                    f ? f : g.modalHeight;
                I = e('<div class="xheModal" style="width:' + (d - 1) + "px;height:" + f + "px;margin-left:-" + Math.ceil(d / 2) + "px;" + (j && 7 > qa ? "" : "margin-top:-" + Math.ceil(f / 2) + "px") + '">' + (g.modalTitle ? '<div class="xheModalTitle"><span class="xheModalClose" title="Close (Esc)" tabindex="0" role="button"></span>' + a + "</div>" : "") + '<div class="xheModalContent"></div></div>').appendTo("body");
                Ea = e('<div class="xheModalOverlay"></div>').appendTo("body");
                0 < da && (Da = e('<div class="xheModalShadow" style="width:' + I.outerWidth() +
                    "px;height:" + I.outerHeight() + "px;margin-left:-" + (Math.ceil(d / 2) - da - 2) + "px;" + (j && 7 > qa ? "" : "margin-top:-" + (Math.ceil(f / 2) - da - 2) + "px") + '"></div>').appendTo("body"));
            ...
            this.showDialog = function(a, b) {
                ...
                if (1 === h.length) {
                    f.find("input[type=text],select").keypress(function(a) {
                        if (13 === a.which) return h.click(), !1
                    });
                    f.find("textarea").keydown(function(a) {
                        if (a.ctrlKey && 13 === a.which) return h.click(), !1
                    });
                    h.after(' <input type="button" id="xheCancel" value="Cancel" />');
                ...
                if (b.e) b.e.call(c);
                    ...
                    case "pastetext":
                        window.clipboardData ?
                            c.pasteText(window.clipboardData.getData("Text", !0)) : c.showPastetext();
                        break;
                    case "blocktag":
                        var i = [];
            ...
            this._exec = function(a, b, d) {
                d || c.focus();
                return b !==
                    Z ? l.execCommand(a, !1, b) : l.execCommand(a, !1, null)
            }
        };
    sa.settings = {
        skin: "default",
    ...
    e(function() {
        ...
        e.fn.val = function(e) {
            var j = this,
                o;
            return e === Z ? j[0] && (o = j[0].xheditor) ? o.getSource() : j.oldVal() : j.each(function() {
                (o = this.xheditor) ? o.setSource(e): j.oldVal(e)
            })
        };
