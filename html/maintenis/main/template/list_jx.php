	...
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><?php echo $row['id']; ?>
                                    <ul class="table-mobile-ul visible-xs list-unstyled">
                                        ...
                                        <?php } ?>
											<li>
												<a href="?go=template&id=<?php echo $row['id'];?>" class="switchpublished"><?php if ($row['default_template']=='1') echo '<a href="#"><img src="../images/tick.png">'; else echo '<img src="../images/warning.png">'; ?></a>
											</li>
											<li>
