		...
		foreach($dataschema as $schema){
			...
			$combobox 			= false;
                ...
                ?>
                    ...
                    <div class="col-sm-1">
                        <?php
                        echo "<?php echo widgetbackend('inputselect',array('field'=>'".$schema['COLUMN_NAME']."','value'=>\$row['".$schema['COLUMN_NAME']."'],'kosong'=>'- pilih -','option'=>\$arrPub".str_replace(' ','_',$schema['COLUMN_NAME']).")); ?>";
                        ?>
					...
					if (!$adarelasi){
						...
						echo "<?php echo widgetbackend('inputselect',array('field'=>'".$schema['COLUMN_NAME']."','value'=>\$row['".$schema['COLUMN_NAME']."'],'kosong'=>'- pilih -','option'=>\$data".str_replace(' ','_',$schema['COLUMN_NAME']).")); ?>";
                                    ...
                                    ?>";
                                        ...
                                        echo '<textarea class="form-control" rows="10" name="'.$schema['COLUMN_NAME'].'"></textarea>';                                    
