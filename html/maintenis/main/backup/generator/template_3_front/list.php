...
$data = doquery('select * from `'.$moduledb.'` order by id');
...
<?php echo "<?php"; ?>	echo widgetbackend('actionmenuplain',array(
										'<a href="index.php?go=<?php echo $namamodule;?>&do=hapus" id="deleteSelected"><img src="'.$config['baseurl'].'/images/delete.png">Hapus</a>',
										'<a href="index.php?go=<?php echo $namamodule;?>&do=tambah" id="deleteSelected"><img src="'.$config['baseurl'].'/images/new.png">Tambah</a>',
												));
<?php echo "?>"; ?>
