...
$default_sort       = array('t.created'=>'desc');
...
if ($sort==''){
    ...
    foreach ($arrSort as $name=>$order){
        ...
        $arrproductort[] = $name.' '.$order; 

    }

    

    $order_by = ' order by '.implode(',', $arrproductort);        
...
if (strlen($keyword)>0){
	...
	foreach($arrKeyword as $rowKeyword){
		$arrWhere[] = 'c.nama_category_alias like "%'.$rowKeyword.'%"';                
	}
	...
	$sql_from = '	from `'.$table_name.'` t 					
				left join ec_category c on t.id_category=c.id
				' . $where.' '.
	...
	$field_select   = ' t.*,c.nama_category_alias  ';
...
//
//<td style="text-align: center;"><input type="checkbox" name="product-check[]" id="product-check-<?php echo $i/
//	
...
<table class="table table-striped table-bordered table-hover">
    ...
    <thead class="flip-content bordered-blue">
        ...
        <tr style="background-color: #eee;">
            ...
            <th class="<?php echo getClassSorting('img_icon',$header_class); ?>">

                <a href="#" class="" data-name="img_icon">

                      Product <span class="<?php echo getClassSortingIcon('img_icon'); ?>"></span>

                </a>

            </th>
            <th class="<?php echo getClassSorting('logobrand',$header_class); ?>">

                <a href="#" class="" data-name="logobrand">

                    Brand <span class="<?php echo getClassSortingIcon('logobrand'); ?>"></span>

                </a>

            </th>  <th class="<?php echo getClassSorting('logobrand',$header_class); ?>">

                <a href="#" class="" data-name="logobrand">

                    Poster Promo <span class="<?php echo getClassSortingIcon('logobrand'); ?>"></span>
...
?>
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><img src="<?php echo $config['baseurl'] .'images/products/'. $row['img_icon']; ?>" alt="" width="102" height="102" />
                                    <ul class="table-mobile-ul visible-xs list-unstyled">
											<li>
												<?php echo $row['title']."<br>".$row['hits']; ?>
											</li>
                                        ...
                                        <?php } ?>
											...
											<li>
												...
												<a href="<?php echo $config['baseurl'].$row['nama_category_alias'].'/'.$row['id'].'-'.$row['title_alias'];?>.html" target="_blank">View Page</a>
											</li>
                                    </ul>
								...
								<td  class="hidden-xs col-medium center" style="text-align: center">
									<img src="<?php echo $config['baseurl'] .'images/logobrand/'. $row['logobrand']; ?>" alt="" width="42"/>
								</td>

								<td  class="hidden-xs col-medium center" style="text-align: center">
									<img src="<?php echo $config['baseurl'] .'images/poster/'. $row['imgpromo']; ?>" alt="" width="42" height="42" />
									</td>
                                <?php foreach ($header_table as $nama_field=>$judul_header) { ?>
