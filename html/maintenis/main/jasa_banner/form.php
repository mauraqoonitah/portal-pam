...
<form class="form-horizontal" name="form1" action="" method="POST">
	...
	<div class="form-group">
		...
		<label class="col-sm-2 control-label">jasa banner Title</label>
	...
	<div class="form-group">
		...
		<?php
				...
				echo widgetbackend('image_uploaderjasa_banner', array( 

															'field' => 'image',

															'path'	=> '../images/jasa_banner',
	...
	<div class="form-group">
		...
		<div class="col-sm-7"><input class="form-control" type="text" name="url" id="url" value="<?php echo $row['url']; ?>" style="width: 500px;"/></div>
