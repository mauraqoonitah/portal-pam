            ...
            <th style="text-align: center; width:50px;">
                <div class="checkbox">
                    <label>
			            ...
			            <th class="<?php echo getClassSorting('nama_status',$header_class); ?>">
                <a href="#" class="" data-name="nama_status">
                    Nama Status<span class="<?php echo getClassSortingIcon('nama_status'); ?>"></span>
                </a>
            </th>
