...
?>
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><?php echo  $row['id']; ?>
                                    <ul class="table-mobile-ul visible-xs list-unstyled">
                                        <?php foreach ($header_table as $nama_field=>$judul_header) { ?>
											...
											<li><a href="<?php echo $config['baseurl']; ?>index.php?go=<?php echo $module; ?>&do=turunkan&id=<?php echo $row['id']?>&tipe=<?php echo $row['menutype'];?>" alt="turunkan" title="turunkan"><img src="<?php echo $config['baseurl']; ?>images/down.png"  alt="turunkan" title="turunkan"/></a> <a href="<?php echo $config['baseurl']; ?>index.php?go=<?php echo $module; ?>&do=naikkan&id=<?php echo $row['id']?>&tipe=<?php echo $row['menutype'];?>"><img src="<?php echo $config['baseurl']; ?>images/up.png"  alt="naikkan" title="naikkan"/></a></li>
								...
								<td  class="hidden-xs col-medium center" style="text-align: center">
									<a href="<?php echo $config['baseurlbackend']; ?>index.php?go=<?php echo $module; ?>&do=turunkan&id=<?php echo $row['id']?>" alt="turunkan" title="turunkan"><img src="<?php echo $config['baseurl']; ?>images/down.png"  alt="turunkan" title="turunkan"/></a> <a href="<?php echo $config['baseurlbackend']; ?>index.php?go=<?php echo $module; ?>&do=naikkan&id=<?php echo $row['id']?>"><img src="<?php echo $config['baseurl']; ?>images/up.png"  alt="naikkan" title="naikkan"/></a>
								</td>
								<td  class="hidden-xs col-medium center" style="text-align: center">
