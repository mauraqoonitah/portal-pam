 ...
 */
	...
	foreach($arrKeyword as $rowKeyword){
        ...
        $arrKeywordAnd[] = ' tmt_pertama like "%'.cari_bulan_depan($bulan).'%" ';
	...
	if (count($arrWhere)>0 || count($arrKeywordAnd)>0){
            $where      = ' where ';
            if (count($arrWhere)==0) {
                $strWhereOr = "tmt_pertama LIKE '%".cari_bulan_depan($bulan)."%'";
...
<div class="x_title">
					...
					<h4>
					Daftar anggota yang dapat diajukan Kenaikan Gaji Berkala Bulan 
						<?php
							$bulan_depan = $bulan+1;
							echo translate_bulan($bulan_depan);
						?>
					</h4>		
...
<table class="table table-striped responsive-utilities jambo_table bulk_action">
            <thead>
                <tr class="headings" style="">
                    <th rowspan="1" style="text-align: center; width:50px;vertical-align: middle">
                        <div class="checkbox">
                            <label>
                    ...
                    <th style="vertical-align: middle" rowspan="1" class="column-title <?php echo getClassSorting('nama',$header_class); ?>">
                        <a href="#" class="judul_table" data-name="nama"> Nama<br/><span class="<?php echo getClassSortingIcon('nama'); ?>"></span></a>
                    </th>                    
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('nrp',$header_class); ?>">
                        <a href="#" class="" data-name="nrp"> NRP<br/><span class="<?php echo getClassSortingIcon('nrp'); ?>"></span></a>
                    </th>
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('tgl_lahir',$header_class); ?>">
                        <a href="#" class="" data-name="tgl_lahir"> Tgl Lahir<br/><span class="<?php echo getClassSortingIcon('tgl_lahir'); ?>"></span></a>
                    </th>
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('pendidikan',$header_class); ?>">
                        <a href="#" class="" data-name="pendidikan"> Pendidikan<br/><span class="<?php echo getClassSortingIcon('pendidikan'); ?>"></span></a>
                        </th>
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('pangkat',$header_class); ?>">
                        <a href="#" class="" data-name="pangkat"> Pangkat / Gol Ruang<br/><span class="<?php echo getClassSortingIcon('pangkat'); ?>"></span></a>
                        </th>
                    <!--<th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('gol_ruang',$header_class); ?>">
                        <a href="#" class="" data-name="gol_ruang"> Gol Ruang<br/><span class="<?php echo getClassSortingIcon('gol_ruang'); ?>"></span></a>
                         </th>-->
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('jabatan',$header_class); ?>">
                        <a href="#" class="" data-name="jabatan"> Jabatan<br/><span class="<?php echo getClassSortingIcon('jabatan'); ?>"></span></a>
                         </th>
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('tmt_pertama',$header_class); ?>">
                        <a href="#" class="" data-name="tmt_pertama"> TMT<br/><span class="<?php echo getClassSortingIcon('tmt_pertama'); ?>"></span></a>
                         </th>
                    <!--<th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('tmt_pangkat',$header_class); ?>">
                        <a href="#" class="" data-name="tmt_pangkat"> TMT Pangkat<br/><span class="<?php echo getClassSortingIcon('tmt_pangkat'); ?>"></span></a>
                    </th>-->
					
					
                    <th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('gaji_sebelumnya',$header_class); ?>">
                        <a href="#" class="" data-name="gaji_sebelumnya"> Gaji<br/><span class="<?php echo getClassSortingIcon('gaji_sebelumnya'); ?>"></span></a>
                    </th>
                    <!--<th style="vertical-align: middle" rowspan="1" class="hidden-xs column-title <?php echo getClassSorting('gaji',$header_class); ?>">
...
<!--                    <th style="vertical-align: middle; text-align: center;" colspan="2" class="hidden-xs column-title ">MK Efektif </th>-->
                    ...
                    <a href="#" class="" data-name="thn_efektif"> MK Efektif<span class="<?php echo getClassSortingIcon('thn_efektif'); ?>"></span></a>
                    </th>
                    <th style="vertical-align: middle" class="hidden-xs column-title <?php echo getClassSorting('thn_efektif',$header_class); ?>">
                    <a href="#" class="" data-name="thn_efektif"> MK Golongan<span class="<?php echo getClassSortingIcon('thn_efektif'); ?>"></span></a>
                    </th>
                    
                    <th style="vertical-align: middle;text-align: center;" rowspan="1" class="hidden-xs column-title no-link last"><span class="nobr">Action</span>
                    </th>
				...
				<td style="text-align: center;">
					 <div class="checkbox">
						...
						echo $row['pangkat_alias'].' / '.$row['gol_ruang'];
                                        ...
                                        echo $row['thn_efektif'].' THN <br/>'.$row['bln_efektif'].' BLN';
                                    } else if ($nama_field=='thn_gol'){
                                        echo $row['thn_gol'].' THN <br/>'.$row['bln_efektif'].' BLN';
									} else {
                                ?>
                                ...
                                <td  class="hidden-xs col-medium center" style="text-align: center">
                                    <a href="<?php echo $config['baseurl'];?>index.php?go=kgb&do=proses&id=<?php echo $row['id']; ?>&ret=kgb" class="btn btn-primary btn-xs" data-placement="top" data-toggle="tooltip" data-original-title="Proses KGB">
