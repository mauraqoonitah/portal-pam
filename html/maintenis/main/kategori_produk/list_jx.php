...
$arrSort            = array();
$default_sort       = array('t.lft'=>'asc');
$table_name         = 'ec_category';
$config['theme']    = '';
...
$header_table = array(  
		                        ...
		                        'nama_category_alias'   => 'nama_category_alias',
		                        'ordering'              => 'Ordering',
		                        'published'             => 'Published',
...
<table class="table table-striped table-bordered table-hover">
    <thead class="flip-content bordered-blue">
        <tr style="background-color: #eee;">
            ...
            <th class="<?php echo getClassSorting('nama_category',$header_class); ?>">
                <a href="#" class="" data-name="nama_category">
                     Nama Category<span class="<?php echo getClassSortingIcon('nama_category'); ?>"></span>
                </a>
            </th>
            ...
            <th class="hidden-xs">ORDERING</th>
...
?>
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><?php echo str_repeat('--',$row['level']) . $row['nama_category']; ?>
                                    <ul class="table-mobile-ul visible-xs list-unstyled">
                                        <?php foreach ($header_table as $nama_field=>$judul_header) { ?>
											<li><?php echo $judul_header; ?>: <?php echo $row[$nama_field]; ?></li>                                        <?php } ?>
											<li><a href="<?php echo $config['baseurl']; ?>index.php?go=<?php echo $module; ?>&do=turunkan&id=<?php echo $row['id']?>&tipe=<?php echo $row['nama_category'];?>" alt="turunkan" title="turunkan"><img src="<?php echo $config['baseurl']; ?>images/down.png"  alt="turunkan" title="turunkan"/></a> <a href="<?php echo $config['baseurl']; ?>index.php?go=<?php echo $module; ?>&do=naikkan&id=<?php echo $row['id']?>&tipe=<?php echo $row['nama_category'];?>"><img src="<?php echo $config['baseurl']; ?>images/up.png"  alt="naikkan" title="naikkan"/></a></li>
											<li><a href="?go=<?php echo $module; ?>&id=<?php echo $row['id'];?>" class="switchpublished"><?php if ($row['published']=='1') echo '<a href="#"><img src="../images/tick.png">'; else echo '<img src="../images/warning.png">'; ?></a></li>
								...
								<td  class="hidden-xs col-medium center" style="text-align: center">
									<a href="<?php echo $config['baseurlbackend']; ?>index.php?go=<?php echo $module; ?>&do=turunkan&id=<?php echo $row['id']?>&tipe=<?php echo $row['nama_category'];?>" alt="turunkan" title="turunkan"><img src="<?php echo $config['baseurl']; ?>images/down.png"  alt="turunkan" title="turunkan"/></a> <a href="<?php echo $config['baseurlbackend']; ?>index.php?go=<?php echo $module; ?>&do=naikkan&id=<?php echo $row['id']?>&tipe=<?php echo $row['nama_category'];?>"><img src="<?php echo $config['baseurl']; ?>images/up.png"  alt="naikkan" title="naikkan"/></a>
								</td>
								<td  class="hidden-xs col-medium center" style="text-align: center">
