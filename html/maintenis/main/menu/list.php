...
<script language="javascript">	
	...
	$('#pilihanmenu').change(function(){
			...
			window.location = 'index.php?go=menu&tipe='+$(this).val();
	...
	$("body").tooltip({ selector: '[data-toggle=tooltip]' });
        ...
        //alert('test');
          ...
          var sort = {};
        		...
        		$('#datalist').load('index.php?go=<?php echo $module;?>&do=list_jx&tipe=<?php echo $_GET['tipe']; ?>');
    ...
    //jika row diklik maka tampilkan data detail    
		...
		$(document).on('click','tbody td[data-id]',function(){        
			...
			window.location = '<?php echo $config['baseurlbackend'].'index.php?go='.$module.'&do=view&id=';?>'+id;
				...
				var page = (typeof current_page === "undefined") ? "1" : current_page;			
					...
					var kirim = 'keyword='+$('#cari').val()+'&per_page='+$('#per_page').val()+'&page='+page+'&sort='+sort_order+$filter_tambahan;				
						...
						$.ajax({		            
							...
							url:'index.php?go=<?php echo $module;?>&do=list_jx&tipe=<?php echo $_GET['tipe']; ?>',		            
			...
			<div class="panel-collapse collapse in" id="ft-0">			
				...
				<div class="widget-body">				
					...
					<!-- konten start di sini -->					
							...
							<div class="col-lg-6">
								<a href="<?php echo $config['baseurlbackend'].'index.php?go='.$module.'&do=tambah'; ?>" class="btn btn-info" style="width: 100px;">                            
									<span class="glyphicon glyphicon-plus"></span> Baru
								</a>	
							</div>	
							<div class="col-lg-3"></div>
							<div class="col-lg-3">
								Pilih Menu <select name="pilihanmenu" id="pilihanmenu" class="form-control">

									<option value="adminmenu" <?php if ($tipe=='adminmenu') echo 'selected="selected"'; ?> >Admin Menu</option>

									<option value="adminiconmenu" <?php if ($tipe=='adminiconmenu') echo 'selected="selected"'; ?>>Admin Icon Menu</option>

									<option value="mainmenu" <?php if ($tipe=='mainmenu') echo 'selected="selected"'; ?>>Main Menu (Front)</option>

									<option value="verticalmainmenu" <?php if ($tipe=='verticalmainmenu') echo 'selected="selected"'; ?>>Vertical Main Menu (Front)</option>
									
									<!--<option value="scannermainmenu" <?php if ($tipe=='scannermainmenu') echo 'selected="selected"'; ?>>Scanner Vertical Main Menu (Front)</option> -->
								...
								<div class="input-group date">	            			
									...
									<span class="input-group-addon ">Per Halaman</span>	            			
										...
										<?php
											...
											echo widgetbackend('inputselect',array(
