        ...
        <tr style="background-color: #eee;">
            ...
            <th class="<?php echo getClassSorting('images',$header_class); ?>">
                ...
                <a href="#" class="" data-name="images">
                      ...
                      Image galeris <span class="<?php echo getClassSortingIcon('images'); ?>"></span>
...
?>
	...
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><img src="<?php echo $config['baseurl'].'/images/galeri/'.$row['image']; ?>" width="30%"/>
