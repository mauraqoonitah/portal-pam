...
if (isset($_GET['id'])){
	...
	$sql = "	select t.id AS id,t.email AS email, t.role as role, 
						...
						p.nama_lengkap,p.telepon,p.email_kontak,p.jabatan,
                                                t.ordering
						from ".$moduledb." t 
...
<form class="form-horizontal" name="form_<?php echo $module; ?>" action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="jabatan" id="jabatan" class="form-control" value="<?php echo $row['jabatan']; ?>" style="width: 30em" placeholder="Jabatan" maxlength="100"/>
                        </div>
                    </div>
