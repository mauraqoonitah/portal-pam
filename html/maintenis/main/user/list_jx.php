...
if (strlen($keyword)>0){
	...
	$field_select   = 't.id AS id,t.email AS email, t.role as role, p.nama_lengkap,p.email_kontak,p.telepon,r.nama_role,t.ordering ';
...
$header_class = array(  
                ...
                'nama_lengkap'    => 'hidden-xs',
						
                'telepon'    => 'hidden-xs',
						
                'email_kontak'    => 'hidden-xs',	    		
