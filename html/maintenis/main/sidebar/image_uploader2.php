...
$path 			= $config['basepath_front'].$param['path'];
/*
if($param['value']==""){
	$default_value  = "images/upload-icon.png";
}else{
	$default_value  = "images/news/".$param['value'];
}
*/
...
$(function(){
		...
		var pathnya = '<?php echo 'http://craftynesia.com/' . $param['path'] . '/'; ?>';
		...
		var formdata = false;
			...
			$('#response').html('<img src="http://craftynesia.com/images/ajax-loader.gif" align="middle" />');
...
<span class="btna">
	Upload File
	<input type="file" <?php echo $readonly; ?> <?php echo $disabled; ?> id="upload<?php echo $fieldid;?>" multiple size="1" class="filehide" /></span><span id="response">
	</span><br/>
        <div class="row">
                <div class="col-md-12">
                    <div style="" id="container_img_<?php echo $fieldid;?>">
                        <img width="100%" src="<?php echo $config['baseurl_front']. $param['path'] . '/' . $default_value; ?>" id="imageview_<?php echo $fieldid;?>" />
                    </div>
                </div>
        </div>
