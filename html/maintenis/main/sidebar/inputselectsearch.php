...
<select <?php echo $readonly; ?> <?php echo $disabled; ?> name="<?php echo $field; ?>" id="<?php echo $fieldid; ?>" <?php if (strlen($class)>0) echo 'class="'.$class.'"'; ?> <?php if (strlen($style)>0) echo 'style="'.$style.'"'; ?> data-live-search="true" data-style="<?php echo $data_style;?>">
<?php
$dataselect = array();
if (count($option)>0){
	if (strlen($kosong)>0){
...
<select  <?php echo $readonly; ?> <?php echo $disabled; ?>  name="<?php echo $field; ?>" id="<?php echo $fieldid; ?>" <?php if (strlen($class)>0) echo 'class="'.$class.'"'; ?> <?php if (strlen($style)>0) echo 'style="'.$style.'"'; ?> data-style="<?php echo $data_style;?>">
<?php
if (count($option)>0){
