...
<div class="item item-hover">
    ...
    <div class="item-image-wrapper">
        ...
        <div class="item-approved" style="padding-left:10px;">
			<?php if ($row['approved']=='1'){
				echo '<i class="fa fa-check-circle"></i> sudah diapprove';
			}else{
				echo ' <i class="fa fa-clock-o"></i> menunggu approval';
			}?>
		</div>
    ...
    <div class="item-name col-lg-12 col-md-12 col-xs-12" align="left">
        <div class="row">
            ...
            <div class="pull-right">
                <a class="btn btn-sm" href="<?php echo $config['baseurl'].'index.php?go='.$module.'&do=edit_produk&id='.$row['id'];?>"><i class="fa fa-edit"></i> Edit</a>
                <a class="btn btn-sm hapus_produk" data-id="<?php echo $row['id'];?>" href="#"><i class="fa fa-trash-o"></i> Delete</a>
                </div>
        </div>
    </div>
</div>    
