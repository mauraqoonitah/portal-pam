...
<select <?php echo $readonly; ?> name="<?php echo $field; ?>" id="<?php echo $fieldid; ?>"  multiple="multiple" class="sel3">
<?php
$dataselect = array();
if (count($option)>0){
	if (strlen($kosong)>0){
...
<select <?php echo $readonly; ?> <?php echo $disabled; ?> name="<?php echo $field; ?>" id="<?php echo $fieldid; ?>"  multiple="multiple" class="sel3">
<?php
if (count($option)>0){
