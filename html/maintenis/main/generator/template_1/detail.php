...
<div class="wide form">
	...
	<div class="row">
		...
		<div style="display:block;width:80%;float:left"><?php echo "<?php"; ?> echo $row['ordering']; <?php echo "?>"; ?>
	</div>

	<div class="row">
		<label>Published</label>
		<div style="display:block;width:80%;float:left"><?php echo "<?php"; ?> echo YaTidak($row['published']); <?php echo "?>"; ?>
	</div>
