...
$header_table = array(  
		<?php 
		$hit = 0;
		$field_exclude = array('id','created_by','created_date','modified_by','modified_date','ordering');
...
<table class="table table-striped table-bordered table-hover">
    <thead class="flip-content bordered-blue">
		...
		?>
                <?php echo "<?php"; ?>  foreach ($header_table as $nama_field=>$judul_header) { <?php echo "?>"; ?>
	...
	<tr data-id="<?php echo "<?php"; ?> echo $row['id']; <?php echo "?>"; ?>">
		...
		foreach($dataschema as $schema){
			...
			if (!in_array($schema['COLUMN_NAME'],$field_exclude)){
					if($hit==2){
	    ?>
								<td data-id="<?php echo "<?php"; ?> echo $row['id']; <?php echo "?>"; ?>"><?php echo "<?php\n"; ?> echo $row['<?php echo $schema['COLUMN_NAME']; ?>']; <?php echo "\n?>"; ?>
		...
		?>
                                <?php echo "<?php\n"; ?> foreach ($header_table as $nama_field=>$judul_header) { <?php echo "\n?>"; ?>
								<td  class="hidden-xs" data-id="<?php echo "<?php"; ?> echo $row['id']; <?php echo "?>"; ?>"><?php echo "<?php"; ?> echo $row[$nama_field]; <?php echo "?>"; ?></td>
                                <?php echo "<?php\n"; ?> } <?php echo "\n?>"; ?>
