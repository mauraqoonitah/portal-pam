...
if (isset($_GET['id'])){
	...
	$dbedit = doquery("select * from portal where id='".$id."'");
...
<form class="form-horizontal" name="form1" action="" method="POST">
	...
	<div class="form-group">
		...
		<label class="col-sm-2 control-label">Portal Title</label>
	...
	<div class="form-group">
		...
		<div class="col-sm-7"><input class="form-control" type="text" name="kategori" id="kategori" value="<?php echo $row['kategori']; ?>" style="width: 300px;"/></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<a href="index.php?go=galeri" class="btn btn-danger">kembali</a>
