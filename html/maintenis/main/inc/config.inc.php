...
$config = array(
		'host' 			=> 'localhost',
				...
				'username' 		=> 'root',
				'password' 		=> '',	
				//'baseurl'		=>  'http://66.96.230.127/elitos/',			
				//	'baseurl'		=> get_base_url(),
				'baseurl'		=>  '158.140.183.130/',			
				'webtitle'	 	=> 'juragan toko',	
...
$config['smptsecure_mail'] 		= $smptsecure_mail;
...
if ($config['dbms']=='firebird'){
	$db = ibase_pconnect ($config['host'].':'.$config['database'], $config['username'], $config['password']) or die('tidak dapat terkoneksi ke database');	
