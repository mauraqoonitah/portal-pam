...
<div class="col-sm-3">
	...
	<div class="form-group">
		...
		<div class="col-sm-3"><input type="text" name="kode_product" id="kode_product" value="<?php echo $row['kode_product']; ?>" style="width: 400px;"/></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3"><input type="text" name="nama_product" id="nama_product" value="<?php echo $row['nama_product']; ?>" style="width: 400px;"/></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3"><input type="text" name="brand" id="brand" value="<?php echo $row['brand']; ?>" style="width: 400px;"/></div>
...
<div class="form-group">
		...
		<div class="col-sm-3"><input type="text" name="ukuran" id="ukuran" value="<?php echo $row['ukuran']; ?>" style="width: 400px;"/></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3"><input type="text" name="url_alias" id="url_alias" value="<?php echo $row['url_alias']; ?>" style="width: 400px;"/></div>
...
<div class="form-group">
		...
		<div class="col-sm-3"><input type="text" name="price" id="price" value="<?php echo $row['price']; ?>" style="width: 400px;"/></div>
