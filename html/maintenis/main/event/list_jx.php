...
if (strlen($keyword)>0){
	...
	$sql_from = '	from `'.$table_name.'` t 					
				...
				left join news_category c on c.id=t.id_kategori
...
$header_class = array(  
				...
				'intro_text'    => 'hidden-xs' ,

				

				'created_by'    => 'hidden-xs' ,
...
<table class="table table-striped table-bordered table-hover">
    ...
    <thead class="flip-content bordered-blue">
        ...
        <tr style="background-color: #eee;">
            ...
            <th class="<?php echo getClassSorting('images',$header_class); ?>">



                <a href="#" class="" data-name="images">



                      Images <span class="<?php echo getClassSortingIcon('images'); ?>"></span>
			...
			<th class="hidden-xs">News Title</th>
...
?>
	...
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><img src="<?php echo $config['baseurl'] .'images/news/'. $row['img_ilustrasi']; ?>" alt="" width="" height="70" />	
