...
if (isset($_GET['id'])){
    ...
    $dbedit = doquery("select n.*,c.nama_category_alias from event n left join news_category c on c.id=n.id_kategori where n.id='".$id."' order by n.created desc");
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
			...
			<div class="x_title">
                ...
                <h4><a href="index.php?go=<?php echo $module; ?>" title="Batal" alt="Batal"><i class="fa fa-arform-group-circle-left" aria-hidden="true"></i> </a> EDIT EVENT<br> </h4>		
...
<form name="form1" class="form-horizontal" role="form" action="" method="post">	
	...
	<div class="form-group">
		...
		<label class="col-sm-2 control-label">Event Title Alias</label>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			...
			<a href="<?php echo $config['baseurl'];?>backend/index.php?go=event" class="btn btn-danger">Tutup</a>
