...
$header_table = array(  
                        ...
                        'title_alias'    => 'Content Title Alias',
                     //  'intro_text'    => 'Content ',
...
?>
	...
	<tr data-id="<?php echo $row['id']; ?>">
								...
								<td data-id="<?php echo $row['id']; ?>"><img src="<?php echo $config['baseurl'] .'images/featured/'. $row['images']; ?>" alt="" width="42" height="42" />

                                    <ul class="table-mobile-ul visible-xs list-unstyled">

                                        <?php foreach ($header_table as $nama_field=>$judul_header) { ?>

											<li><?php echo $judul_header; ?>: <?php echo substr($row[$nama_field],40); ?></li>                                        <?php } ?>
