                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    ...
                                    <li><a href="<?php echo $config['baseurl']; ?>index.php?go=user&do=logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                            ...
                            <li style="float:left;font-size:24px;padding-top:13px;color:#63C7C6;font-weight:bold;">Admin Panel 7SKY Studio</li>
