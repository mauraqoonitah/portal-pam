...
<div class="wide form">
		<div class="row">
		<label>Nama</label>
		<div style="display:block;width:80%;float:left"><?php echo $row['nama']; ?>	</div>				
		<div class="row">
		<label>Widget</label>
		<div style="display:block;width:80%;float:left"><?php echo $row['widget']; ?>	</div>				
		<div class="row">
		<label>Posisi</label>
		<div style="display:block;width:80%;float:left"><?php echo $row['posisi']; ?>	</div>				
		<div class="row">
		<label>Keterangan</label>
		<div style="display:block;width:80%;float:left"><?php echo $row['keterangan']; ?>	</div>				
		<div class="row">
