	...
	<!--<div class="art-content-layout-row"> -->
		...
		<div class="blok">
			...
			<div>
				...
				<img style="margin-bottom: -10px; border-style:solid; border-width:0px; border-color: #5c5c5c" width="100%" height="100%" alt="" class="art-lightbox" alt="<?php echo $product['nama_product'];?>" src="<?php echo $config['baseurl']; ?>images/poster/<?php echo $product['imgpromo'];?>">
				</p>
				</a>
			</div>
