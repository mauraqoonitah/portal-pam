...
<div class="row">
		...
		foreach($datanews as $news)
			...
			$url_berita = $config['baseurl'].'event/'.$news['id'].'-'.$news['title_alias'].'.html';
   ...
   <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center animate-box">
                    <a href="<?php echo$config['baseurl']?>index.php?go=event-all" class="btn btn-white btn-outline btn-lg btn-block">View All</a>
                </div>
            </div>
