...
if (strcmp($chek_ip, $intern_ip) !== 0) 
   {
   echo 'IP: ' .$chek_ip;
   echo '<div class="error"><h1>Maaf, Aplikasi Sistem Informasi Laboratorium hanya dapat diakses dalam lingkungan kantor PAMJAYA</h1></div>';
   } 
else 
   { 
    header('Location: http://172.16.1.5'); 
   } 
